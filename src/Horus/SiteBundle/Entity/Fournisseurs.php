...
//        $this->path = sha1(uniqid(mt_rand(), true)).'.'.$this->file->guessExtension();
     ...
     * Add fournisseurs
     *
     * @param Horus\SiteBundle\Entity\Produit $fournisseurs
     * @return Fournisseurs
     */
    public function addFournisseur(\Horus\SiteBundle\Entity\Produit $fournisseurs)
    {
     ...
     * @param Horus\SiteBundle\Entity\Produit $fournisseurs
     */
    public function removeFournisseur(\Horus\SiteBundle\Entity\Produit $fournisseurs)
    {
