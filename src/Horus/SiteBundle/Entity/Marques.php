...
//        $this->path = sha1(uniqid(mt_rand(), true)).'.'.$this->file->guessExtension();
     ...
     * Add marques
     *
     * @param Horus\SiteBundle\Entity\Marques $marques
     * @return Marques
     */
    public function addMarque(\Horus\SiteBundle\Entity\Marques $marques)
    {
     ...
     * @param Horus\SiteBundle\Entity\Marques $marques
     */
    public function removeMarque(\Horus\SiteBundle\Entity\Marques $marques)
    {
