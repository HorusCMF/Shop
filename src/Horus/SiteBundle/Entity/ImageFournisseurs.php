 ...
 * ImageCategory
 * @ORM\Entity
 * @ORM\Table(name="images_fournisseur")
 * @ORM\HasLifecycleCallbacks()
 */
class ImageFournisseurs
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Fournisseurs",inversedBy="images")
    ...
    {
        return null === $this->path ? null : $this->getUploadRootDir().'/'.$this->getFournisseur()->getId().'/'.$this->path;
    }
