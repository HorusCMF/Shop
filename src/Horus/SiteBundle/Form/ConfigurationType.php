...
class ConfigurationType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('background', 'text', array('attr' => array('class' => 'colorpicker form-control','placeholder' => "Couleur de fond")))
            ->add('color', 'text', array('attr' => array('class' => 'colorpicker form-control','placeholder' => "Couleur des textes")))
            ->add('title', 'text', array('attr' => array('class' => 'colorpicker form-control','placeholder' => "Couleurs des titres")))
            ->add('panel', 'text', array('attr' => array('class' => 'colorpicker form-control','placeholder' => "Couleurs des panels")))
