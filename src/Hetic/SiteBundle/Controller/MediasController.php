...
class MediasController extends Controller
{
    ...
    public function mediasAction()
    {
        ...
        $medias = $em->getRepository('HeticSiteBundle:Image')->findAll();
        $mediascat = $em->getRepository('HeticSiteBundle:ImageCategory')->findAll();
        ...
        return $this->render('HeticSiteBundle:Medias:medias.html.twig', array(
            'medias' => $pagination,
